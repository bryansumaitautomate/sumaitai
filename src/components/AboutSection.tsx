      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 relative">
        ...
        >
          ...
          <div className="lg:col-span-1 flex flex-col gap-4">
            ...
            <div 
              className="group rounded-2xl border border-white/10 p-6 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:shadow-[0_20px_40px_rgba(239,68,68,0.15)]"
              style={{
