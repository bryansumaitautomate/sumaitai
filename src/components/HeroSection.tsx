      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="grid grid-cols-4 border-b border-white/10">
          ...
          <div className="p-6 flex items-center justify-end col-span-3 md:col-span-1">
            <a href="#contact" className="font-mono text-xs tracking-[0.2em] text-white/60 hover:text-white transition-colors">
              LET'S TALK →
            </a>
          </div>
        </div>
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-4">
          ...
          <div className="p-8 md:p-12 flex flex-col justify-between">
            ...
            delay: 0.8
              ...
              <a href="#systems" className="group inline-flex items-center gap-3 font-mono text-xs tracking-[0.2em] text-white border border-white/20 px-6 py-4 hover:border-[#EF4444] hover:text-[#EF4444] transition-all duration-300">
                VIEW WORK
