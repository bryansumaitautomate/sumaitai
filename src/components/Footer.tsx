...
const Footer = () => {
  ...
  return (
    <footer className="relative z-10 border-t border-white/10 mt-20 py-12 bg-[#0a0a0a]">
            ...
            <div className="flex flex-col lg:flex-row justify-between gap-10">
              ...
              <div className="max-w-md">
                ...
                <p className="mt-4 text-sm text-white/50 leading-relaxed">
                  Building revenue systems that capture leads, close deals, and run 24/7—so service businesses never miss a sale.
                </p>
                ...
                <form onSubmit={handleSubmit} className="mt-6 flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 rounded-full bg-white/5 text-white placeholder-white/40 px-4 py-3 text-sm ring-1 ring-white/10 focus:ring-2 focus:ring-[#ef4444]/30 outline-none transition"
                    required
                  />
                  <button
                    type="submit"
              ...
              <div className="flex items-center gap-2">
                {socialLinks.map((link, index) => (
                  <a
                    key={index}
                    href={link.href}
                    className="h-8 w-8 rounded-full bg-white/5 ring-1 ring-white/10 hover:bg-white/10 transition flex items-center justify-center"
